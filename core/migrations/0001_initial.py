# Generated by Django 4.2.16 on 2024-11-06 02:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('process', 'Processando'), ('shipped', 'Enviado'), ('delivered', 'Entregue')], default='processing', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Cerveja', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Utina Beer', max_length=100)),
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999)),
                ('old_price', models.DecimalField(decimal_places=2, default='2.99', max_digits=99999)),
                ('specifications', models.TextField(blank=True, default='Cerveja de Okinawa', null=True)),
                ('product_status', models.CharField(choices=[('draft', 'Carrinho'), ('disabled', 'Desabilitado'), ('rejected', 'Rejeitado'), ('in_review', 'Em revisão'), ('published', 'Publicado')], default='in_review', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='product.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='Produto', null=True)),
                ('address', models.CharField(default='123 Rua tal, Sao Paulo', max_length=100)),
                ('contact', models.CharField(default='11 9999999', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999)),
                ('total', models.DecimalField(decimal_places=2, default='1.99', max_digits=99999)),
